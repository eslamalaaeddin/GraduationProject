...
import com.example.graduationproject.cache.dao.UsersDao
...
@Database(entities = arrayOf(FavoriteProduct::class, Product::class, User::class), version = 1, exportSchema = false)
